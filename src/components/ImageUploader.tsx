...
export default function ImageUploader({ onUpload }: ImageUploaderProps = {}) {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="bg-neutral-800/50 backdrop-blur-sm rounded-2xl shadow-xl border border-neutral-700/50 p-8">
                {/* Header */}
                ...
                {uploadResult ? (
                    <div className="space-y-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-300">Your file is now available on the global CDN</p>
                        </div>
                        ...
                        <div className="text-center">
                            <div className="inline-block relative">
                                <Image
                                    ...
                                    width={300}
                                    height={200}
                                    className="max-w-sm max-h-64 rounded-xl shadow-lg object-contain border border-neutral-600"
                                    unoptimized
                                />
                            ...
                            <div className="mt-3 text-sm text-gray-300">
                                ...
                                <p className="text-gray-400">{formatFileSize(uploadResult.size)} • {uploadResult.type}</p>
                            </div>
                        </div>
                            ...
                            <div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 rounded-xl p-6 border border-orange-500/20">
                                <div className="flex items-center mb-3">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <h4 className="font-semibold text-orange-300">Recommended: jsDelivr CDN URL</h4>
                                    </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    <input
                                        ...
                                        readOnly
                                        className="flex-1 px-4 py-3 border border-orange-500/30 rounded-lg text-sm bg-neutral-900/50 font-mono text-gray-200"
                                    />
                                    <button
                                        onClick={() => copyToClipboard(uploadResult.urls!.jsdelivr_commit)}
                                        className="flex items-center space-x-2 px-4 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors font-medium"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="p-3 bg-neutral-700/50 text-gray-300 rounded-lg hover:bg-neutral-600 transition-colors"
                                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-4">
                                ...
                                {uploadResult.urls?.raw_commit && (
                                    <div className="bg-neutral-700/30 rounded-lg p-4 border border-neutral-600/50">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-sm font-medium text-gray-300">Raw GitHub URL (Permanent)</span>
                                            <span className="text-xs bg-green-500/20 text-green-300 px-2 py-1 rounded-full">Permanent</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="text"
                                                ...
                                                readOnly
                                                className="flex-1 px-3 py-2 border border-neutral-600/50 rounded text-xs bg-neutral-900/30 font-mono text-gray-300"
                                            />
                                            <button
                                ...
                                {uploadResult.urls?.jsdelivr && (
                                    <div className="bg-neutral-700/30 rounded-lg p-4 border border-neutral-600/50">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-sm font-medium text-gray-300">jsDelivr CDN (Branch-based)</span>
                                            <span className="text-xs bg-yellow-500/20 text-yellow-300 px-2 py-1 rounded-full">Dynamic</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="text"
                                ...
                                {uploadResult.urls?.github_commit && (
                                    <div className="bg-neutral-700/30 rounded-lg p-4 border border-neutral-600/50">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-sm font-medium text-gray-300">GitHub Repository URL</span>
                                            <span className="text-xs bg-neutral-600/50 text-gray-300 px-2 py-1 rounded-full">Source</span>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="text"
                    ...
                    <div>
                        {previewFile && (
                            <div className="mb-8 text-center">
                                ...
                                <p className="text-sm text-gray-300 mt-3 font-medium">{previewFile.file.name}</p>
                            </div>
                        )}
                        ...
                        <div
                            className={`
                                ...
                                ${isDragging
                                    ...
                                    : 'border-neutral-600 hover:border-orange-400 hover:bg-orange-500/5'
                                }
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-500/20 rounded-2xl">
